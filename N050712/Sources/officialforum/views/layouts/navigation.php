<div class="navbar navbar-inverse navbar-static-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php?controller=pages&action=home"><span class="glyphicon glyphicon-home"></span> Trang chủ</a>
            <a class="navbar-brand" href="index.php?controller=forum&action=forum"><span class="glyphicon glyphicon-globe"></span> Diễn đàn</a> 
        </div>
        <div class="navbar-collapse collapse">
                ...
                if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true){
                     // && $_SESSION['access_level']=='Customer'||$_SESSION['access_level']=='Customer VIP'
                ?>
